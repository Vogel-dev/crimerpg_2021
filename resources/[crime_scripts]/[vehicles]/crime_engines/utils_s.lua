...
VEHICLES_TYPES = {
	["Bus"] = {431, 437},
	["Truck"] = {403, 406, 407, 408, 414, 427, 432, 433, 443, 444, 455, 456,
				 498, 499, 514, 515, 524, 531, 544, 556, 557, 573, 578, 601},
	["Sport"] = {411, 415, 424, 429, 451, 477, 480, 494, 495, 502, 504, 506, 541, 555, 558, 559, 560,
						 562, 565, 568, 587, 602, 598, 609, 413},
	...
	["Muscle"] = {474, 545, 466, 467, 439, 542, 603, 475, 419, 402, 503},
	...
	["Motorbike"] = {462, 521, 463, 522, 461, 448, 468, 586, 471, 581, 572},
}
...
function calculateVehicleClass(vehicle)
	...
	if type(vehicle) == "number" then 
		...
		v_type = getElementData(vehicle, "vehicleSound:type")
	end
